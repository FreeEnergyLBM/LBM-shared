...
class AdvectionDiffusion : public CollisionBase<TLattice,typename TTraits::Stencil>, public ModelBase<TLattice, TTraits> { //Inherit from base class to avoid repetition of common
    ...
    public:
        ...
        inline void setDiffusivity(double D) {mTau=D/Stencil::Cs2+0.5*TLattice::DT; mInverseTau=1.0/mTau;}
...
inline void AdvectionDiffusionCorrected<TZerothMoment, TZerothMomentOld, TLattice, TTraits>::collide() { //Collision step
...
template<class TZerothMoment, class TZerothMomentOld, class TLattice, class TTraits>
inline void AdvectionDiffusionCorrected<TZerothMoment, TZerothMomentOld, TLattice, TTraits>::initialise() { //Initialise model
...
template<class TZerothMoment, class TZerothMomentOld, class TLattice, class TTraits>
inline double AdvectionDiffusionCorrected<TZerothMoment, TZerothMomentOld, TLattice, TTraits>::computeEquilibrium(int k, int idx) {
