...
// This example performs a simple evaporation where the evaporation rate is proportional to the surface area (using SimpleMassLossCalculator)
...
using OrderParameterGradients = GradientsMultiStencil<
        OrderParameter<>,
        CentralXYZ,
        CentralQ,
        MixedXYZ,
