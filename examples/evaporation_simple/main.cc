...
using TraitBinary =
    DefaultTraitBinaryLeeHumidity<Lattice>::SetProcessor<Gradients<ChemicalPotential<>, LaplacianCentralMirrorSolid>,
                                                         OrderParameterGradients, ChemicalPotentialCalculatorBinaryLee,
                                                         SimpleMassLossCalculator, NoFluxSolid<OrderParameter<>>>;
