...
// This script simulates two phase flow.
...
int main(int argc, char **argv) {
    ...
    using TraitBinary = DefaultTraitBinary<Lattice>::template SetProcessor<
        std::tuple<ConvectOP>, std::tuple<Gradients<ChemicalPotential<>, LaplacianCentralMirrorSolid>>,
        std::tuple<GradientsMultiStencil<OrderParameter<>, CentralXYZ, CentralQ, MixedXYZ, MixedQ, LaplacianCentral>>,
        std::tuple<ChemicalPotentialCalculatorBinary, CubicWetting, SimpleMassLossCalculator,
                   NoFluxSolid<OrderParameter<>>, SetParameterOld<OrderParameter<>, OrderParameterOld<>>>>::
