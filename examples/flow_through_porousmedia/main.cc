...
// This script simulates two phase flow through a porous structure. 
...
int main(int argc, char **argv)
{
    ...
    using TraitFlowFieldBinary = DefaultTraitFlowFieldBinary<Lattice>::SetCollisionOperator<MRT>::SetBoundary<std::tuple<VelocityInflow, Convective>,std::tuple<BounceBack>>;
    using TraitBinary = DefaultTraitBinary<Lattice>::template SetProcessor<std::tuple<ConvectOP>,
